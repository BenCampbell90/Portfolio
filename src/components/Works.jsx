      ...
      <Tilt options={{ max: 45, scale: 1, speed: 450 }} className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full">
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              <img src={internet} alt="internet" className="w-1/2 h-1/2 object-contain" />
            </div>
            <div
    ...
    <>
      ...
      <div className="w-full flex">
        <motion.p variants={fadeIn('', '', 0.1, 1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          ...
          to the code respositories and live demos. It reflects my ability to solve complex problems, work with different technologies, and manange
          projects effectivley.
        </motion.p>
      </div>
